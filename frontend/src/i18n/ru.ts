  ...
  pages: {
    ...
    outboundUpsert: {
      ...
      urltest: {
        ...
        groupsDescription:
          "Добавьте туннели в порядке предпочтения. Способ выбора доступного туннеля задаётся ниже.",
        groupTitle: "Ступень {{index}}",
        groupDescription:
          "Ступень {{index}} — туннели верхних ступеней предпочтительнее; следующая используется, когда верхняя недоступна.",
        groupWeight: "Вес ступени",
        groupWeightHint:
          "Меньший вес имеет более высокий приоритет. Пустое поле означает стандартный вес 1.",
        interfaceOutbounds: "Туннели",
        addOutbound: "Добавить туннель",
        noInterfaceOutbounds: "Туннели с маршрутом не найдены.",
        addInterfaceOutboundsFirst:
          "Сначала создайте маршрут хотя бы для одного туннеля, чтобы группе было из чего выбирать.",
