export const ruTranslation = {
  nfqws: {
    ...
    breakdown: {
      ...
      liveWarming: "В этом пуле трафик пока не наблюдался.",
      livePartial:
        "Получена только часть живого состояния — точный слот скрыт.",
      liveSlot: "Слот {{slot}} из {{count}} · целей: {{targets}}",
  ...
  transports: {
    ...
    title: "VPN и прокси",
    description:
      "Управляемые VPN и прокси, которые создают интерфейсы для маршрутизации keen-pbr.",
    tabs: {
      all: "Все",
      other: "Другие",
    ...
    routeOffer: {
      ...
      question:
        "«{{name}}» ещё не используется как VPN в keen-pbr-sb. Создать для него маршрут?",
      create: "Создать маршрут",
      dismiss: "Не предлагать",
      created:
        "Маршрут «{{name}}» создан в черновике — примените конфигурацию, чтобы он заработал.",
    },
    ...
    form: {
      ...
      createTitle: "Добавить VPN или прокси",
