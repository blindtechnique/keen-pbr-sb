export const ruTranslation = {
  ...
  transports: {
    ...
    nativeInterface: {
      ...
      routeNotClient:
        "К маршруту можно привязать только интерфейс, который KeeneticOS однозначно определил как клиентский туннель.",
      routeUnresolved:
        "Маршрут нельзя создать, пока KeeneticOS не определит имя интерфейса Linux.",
      routeNotLive:
