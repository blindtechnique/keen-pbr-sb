  ...
  pages: {
    ...
    outbounds: {
      plain: {
        ...
        urltest:
          "Группа автоматически переключается на работающий туннель",
        table: "Трафик идёт напрямую через провайдера, мимо туннелей",
        blackhole: "Соединения не выпускаются наружу",
        ignore: "Трафик проходит без изменения маршрута",
      },
      ...
      actions: { new: "Добавить маршрут или группу" },
      bulk: {
        selected: "Выбрано: {{count}}",
        delete: "Удалить выбранные",
        confirmDelete:
    ...
    outboundUpsert: {
      ...
      cardDescription:
        "Настройте маршрут, системное действие или группу.",
      missing: {
    ...
    listUpsert: {
      ...
      quickSetup: {
        ...
        routeRequired:
          "Выберите маршрут или группу для правила маршрутизации.",
