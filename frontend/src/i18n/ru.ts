  ...
  transports: {
    ...
    nativeMutation: {
      ...
      recovery: {
        ...
        unsafeTitle: "Журнал операций native VPN нельзя считать надёжным",
        unsafeDescription:
          "Роутер не может выдать безопасное состояние журнала. Новые записи заблокированы; автоматической очистки и повторов нет.",
