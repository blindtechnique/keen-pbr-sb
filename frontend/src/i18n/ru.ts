export const ruTranslation = {
  ...
  transports: {
    ...
    exitCheck: {
      ...
      requestFailed: "Не удалось выполнить проверку.",
      changed:
        "Работает: снаружи виден {{through}}, а без подключения — {{direct}}.",
      same:
        "Ответ пришёл, но адрес не изменился: и так, и так виден {{direct}}. Трафик идёт мимо подключения.",
      noControl:
        "Трафик ушёл через это подключение, снаружи виден {{through}}. Сравнить не с чем — прямая проверка не ответила.",
      unattributed:
        "Проверить не удалось: не к чему привязать запрос, поэтому ответ ничего не говорит именно об этом подключении.",
      unreachable: "Через это подключение ответа нет.",
    },
    loopProtection: {
