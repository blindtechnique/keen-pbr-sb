export const ruTranslation = {
  ...
  transports: {
    ...
    nativeImport: {
      ...
      unknownTitle: "Результат импорта пока не получен",
      unknownDescription:
        "Панель автоматически сверяет результат с роутером; конфигурация повторно не отправляется.",
      noBlindRetry:
        "Подождите завершения автоматической проверки. Если интерфейс не появится, выберите конфигурацию заново.",
      results: {
