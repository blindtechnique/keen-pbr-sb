export const ruTranslation = {
  ...
  configTransfer: {
    ...
    replaceTransportConflicts:
      "Заменить существующие туннели и прокси с тегами: {{tags}}? Если отменить, конфликтующие записи будут пропущены.",
    transportSecretsWarning:
      "Файл экспорта содержит ссылки подключения, пароли и другие секреты туннелей и прокси. Сохранить его на этот компьютер?",
  ...
  transports: {
    naiveComponent: {
      ...
      installing: "Скачиваю…",
      installed: "Компонент установлен, туннель или прокси можно запускать",
    ...
    started: "Запуск туннеля или прокси запрошен",
    stopped: "Остановка туннеля или прокси запрошена",
    restarted: "Перезапуск туннеля или прокси запрошен",
    ...
    configMessages: {
      ...
      delete: "Туннель или прокси удалён",
    },
    form: {
      createOutbound: "Сразу создать маршрут",
      createOutboundHint:
        "Туннель или прокси появится в разделе «Маршруты и группы» под тем же именем, и его сразу можно будет выбрать в правилах маршрутизации.",
      outboundExists: "Маршрут с названием {{tag}} уже существует",
      createTitle: "Добавить туннель или прокси",
      editTitle: "Изменить туннель или прокси",
      missingTitle: "Туннель или прокси не найден",
      missingDescription:
        "Вернитесь к списку туннелей и прокси и выберите существующую запись.",
      back: "Назад к туннелям и прокси",
    ...
    routing: {
      title: "Туннель или прокси пока не используется в маршрутах",
      description:
  ...
  overview: {
    ...
    services: {
      ...
      noTransports: "Туннели и прокси не настроены",
    ...
    pageDescription:
      "Обзор состояния маршрутизации, маршрутов, туннелей и прокси",
    runtime: {
      title: "Маршрутизация",
  ...
  pages: {
    ...
    routesAndTunnels: {
      ...
      description:
        "Через что уходит трафик: туннели и прокси, интерфейсы роутера, группы туннелей и системные направления.",
      tabs: {
