export const ruTranslation = {
  nfqws: {
    ...
    restoreComponentConfirmDescription:
      "Бинарь, конфигурация и списки, захваченные прямо перед последним обновлением, будут записаны обратно, а служба перезапущена на них.",
    ...
    serviceHelp: {
      ...
      upgrade:
        "Ставит новую версию самого nfqws2 из репозитория. Настройки, списки и стратегии остаются на месте.",
      captureRestorePoint:
      ...
      restoreComponent:
        "Возвращает файлы nfqws2, сохранённые прямо перед последним обновлением, — бинарь, конфигурацию и списки — и перезапускает службу.",
      backup:
