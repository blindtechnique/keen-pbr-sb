export const ruTranslation = {
  ...
  configTransfer: {
    ...
    replaceOutboundConflicts:
      "Заменить существующие маршруты и группы резервирования с тегами: {{tags}}? Если отменить, конфликтующие записи будут пропущены.",
  ...
  transports: {
    ...
    form: {
      ...
      createOutboundHint:
        "Туннель или прокси появится в разделе «Маршруты и резервирование» под тем же именем, и его сразу можно будет выбрать в правилах маршрутизации.",
    ...
    routing: {
      ...
      description:
        "Сначала создайте для этого интерфейса маршрут типа «Интерфейс». Для автоматического переключения создайте группу резервирования URLTest и добавьте в неё два или больше интерфейсных маршрута.",
  ...
  overview: {
    ...
    outbounds: {
      ...
      loadError: "Не удалось загрузить состояние маршрутов и резервирования.",
      emptyTitle: "Маршруты и резервирование не настроены",
      emptyDescription:
        "Добавьте маршрут или резервирование, чтобы видеть его состояние.",
      inUse: "Используется",
    ...
    diagnosticsDownload: {
      ...
      modal: {
        ...
        items: {
          ...
          outbounds: "Состояние маршрутов и резервирования",
  ...
  pages: {
    ...
    outbounds: {
      ...
      tabs: {
        ariaLabel: "Разделы маршрутов и резервирования",
      },
      title: "Маршруты и резервирование",
      description:
        "Куда уходит трафик: туннели и интерфейсы, группы резервирования и системные выходы.",
      actions: { new: "Добавить маршрут или резервирование" },
      bulk: {
        selected: "Выбрано: {{count}}",
        delete: "Удалить выбранные",
        confirmDelete:
          "Удалить маршруты и группы резервирования: {{count}}? Связи проверяются только при сохранении.",
      },
      deleteDialog: {
        title: "Удалить маршрут или резервирование?",
        description:
          "При подтверждении операции будут произведены следующие действия:",
        confirm: "Удалить",
        items: {
          ...
          urltestGroupRemoved:
            'Группа #{{group}} в резервировании "{{outbound}}" будет удалена.',
          groupOutbounds: "Маршруты группы",
        },
      },
      empty: {
        title: "Маршруты и резервирование пока не настроены",
        description:
          "Добавьте маршрут или резервирование, чтобы начать настраивать движение трафика.",
      },
      headers: {
        tag: "Название",
        type: "Тип",
    ...
    outboundUpsert: {
      createTitle: "Создать маршрут или резервирование",
      editTitle: "Изменить маршрут или резервирование",
      editCardTitle: "Изменить {{tag}}",
      description:
        "Маршрут может вести через сетевой интерфейс, существующую таблицу маршрутизации или группу резервирования, которая выбирает доступный вариант.",
      cardDescription:
        "Настройте маршрут, системное действие или резервирование.",
      missing: {
        cardDescription: "Запрошенный маршрут или резервирование не найдено.",
        cardTitle: "Маршрут не найден",
        description:
          "Вернитесь в раздел «Маршруты и резервирование» и выберите существующую запись.",
      ...
      urltest: {
        ...
        addInterfaceOutboundsFirst:
          "Сначала добавьте маршруты через интерфейс, чтобы группе резервирования было из чего выбирать.",
