export const ruTranslation = {
  ...
  transports: {
    ...
    routing: {
      ...
      createOutbound: "Сделать точкой выхода",
      createFailover: "Создать резервирование",
      bindOutbound: "Сделать точкой выхода",
    },
    states: {
  ...
  overview: {
    ...
    outbounds: {
      ...
      title: "Точки выхода",
      loadError: "Не удалось загрузить состояние точек выхода.",
      emptyTitle: "Точки выхода не настроены",
      emptyDescription: "Добавьте точку выхода, чтобы видеть, работает ли она.",
      inUse: "Используется",
  ...
  pages: {
    ...
    settings: {
      remoteAccess: {
        ...
        description: "Открыть веб-интерфейс из интернета, а не только из домашней сети.",
        enabled: "Разрешить доступ из интернета",
        port: "Внешний порт",
        portHint: "Порт, по которому панель будет доступна снаружи. Стоит выбрать нестандартный.",
        warning:
    ...
    outbounds: {
      plain: {
        ...
        urltest: "Резервирование: если первый выход не отвечает, трафик уходит в следующий",
      ...
      title: "Точки выхода",
      description: "Куда можно направить трафик: туннели, интерфейсы и группы резервирования.",
      actions: { new: "Добавить точку выхода" },
      bulk: {
        selected: "Выбрано: {{count}}",
        delete: "Удалить выбранные",
        confirmDelete:
