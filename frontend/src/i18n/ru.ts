    ...
    settings: {
      ...
      advanced: {
        ...
        metaUdp443PolicyWarningDescription:
          "Режим блокирует QUIC Meta/WhatsApp по UDP/443 только на маршруте keen-pbr-sb, покрытом штатным дополнительным IP-списком, и переводит сообщения и медиа на TCP. Он также затрагивает Instagram и другие сервисы Meta в этих IP-диапазонах. Это повышает надёжность сообщений, но звук может появиться через 10–20 секунд после мгновенного уведомления о звонке. STUN, ICE, P2P и весь остальной UDP-трафик звонков остаются разрешены.",
