export const ruTranslation = {
  ...
  transports: {
    ...
    form: {
      ...
      createOutboundHint: "Туннель появится в списке исходящих соединений под тем же именем, и его сразу можно будет выбрать в правилах маршрутизации.",
  ...
  overview: {
    ...
    outbounds: {
      ...
      emptyDescription: "Добавьте исходящее соединение, чтобы видеть, работает ли оно.",
      inUse: "Используется",
  ...
  pages: {
    ...
    outbounds: {
      ...
      title: "Исходящие соединения",
      description: "Куда уходит трафик: туннели, интерфейсы и группы резервирования.",
    ...
    listUpsert: {
      ...
      quickSetup: {
        ...
        routeRequired: "Выберите исходящее соединение для правила маршрутизации.",
