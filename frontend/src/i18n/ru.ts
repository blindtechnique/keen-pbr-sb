export const ruTranslation = {
  ...
  overview: {
    summary: {
      healthy: {
        ...
        description:
          "Маршрутизация, DNS, туннели и прокси работают штатно.",
      },
      waiting: {
  ...
  pages: {
    ...
    outboundUpsert: {
      ...
      cardDescription: "Настройте маршрут, системное действие или резервирование.",
      missing: {
      ...
      urltest: {
        ...
        groupsDescription:
          "Добавьте маршруты в группу. Самый быстрый доступный маршрут по результатам URLTest будет выбран автоматически.",
