  ...
  transports: {
    ...
    nativeMutation: {
      ...
      recovery: {
        ...
        pendingDescription:
          "В этой или другой вкладке есть незавершённая однократная операция. Новые записи заблокированы до типизированного ответа или явной проверки восстановления.",
        ...
        outcomes: {
          ...
          import_blocked: {
            title: "Восстановление импорта остаётся заблокированным",
            description:
    ...
    nativeImport: {
      ...
      ownerRiskExplanation:
        "Операция исключает только других писателей keen-pbr и не может заблокировать все инструменты Keenetic. До извлечения одноразового секрета выполняется проверка допуска и повторный вход без тела запроса.",
      ...
      preflightFailedDescription:
        "Конфигурация не отправлена и остаётся в одноразовом хранилище этой страницы. Проверьте вход или незавершённое восстановление — после этого можно повторить только проверку без тела.",
      ...
      unknownTitle: "Результат импорта неизвестен",
      unknownDescription:
        "Панель больше не может доказать, дошёл ли одноразовый запрос до Keenetic и завершился ли он. Копия выбранных данных в памяти недоступна, элементы управления заблокированы.",
      noBlindRetry:
        "Не импортируйте тот же профиль повторно. До новой записи завершите проверку восстановления native-импорта.",
      results: {
        ...
        recovery_requiredTitle: "Требуется восстановление native-импорта",
