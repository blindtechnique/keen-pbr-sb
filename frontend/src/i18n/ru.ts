  ...
  nfqws: {
    ...
    profiles: {
      ...
      description: {
        ...
        max: "Всё из обычного плюс дополнительные приёмы: syndata, фрагментация IP и подмена в QUIC. Экспериментальный: некоторые провайдеры могут разрывать соединение.",
      },
    },
