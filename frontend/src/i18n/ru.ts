export const ruTranslation = {
  ...
  transports: {
    ...
    nativeInterface: {
      ...
      managedByFirmware:
        "Существующий интерфейс KeeneticOS: создание, изменение, включение, перезапуск и удаление здесь пока отключены",
      ...
      managementReadOnlyDescription:
        "keen-pbr-sb сейчас только показывает этот существующий интерфейс KeeneticOS и может создать маршрут к нему. Создание, изменение и удаление самого интерфейса в панели отключены.",
