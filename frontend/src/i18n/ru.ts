  ...
  pages: {
    ...
    outboundUpsert: {
      ...
      urltest: {
        ...
        groupsDescription:
          "Добавьте маршруты в порядке предпочтения. Способ выбора доступного маршрута задаётся ниже.",
        ...
        addInterfaceOutboundsFirst:
          "Сначала добавьте маршруты через интерфейс, чтобы группе было из чего выбирать.",
