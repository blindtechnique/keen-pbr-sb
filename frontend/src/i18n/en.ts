export const enTranslation = {
  ...
  overview: {
    ...
    routingDiagnostics: {
      ...
      pathRule: "Selected rule",
      pathFirewall: "Firewall",
      pathKernel: "Kernel route",
      pathDefault: "Default route",
      pathUnknown: "Could not confirm",
      pathFirewallMarked: "{{outbound}}, mark {{mark}}",
      pathKernelResolved: "{{interface}}",
      pathKernelResolvedTable: "{{interface}}, table {{table}}",
      pathKernelTableOnly: "Table {{table}}",
      pathKernelUnroutable: "Routing is blocked",
      pathKernelUnavailable: "Could not confirm the route",
