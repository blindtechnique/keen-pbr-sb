...
/**
 * Кольцо «куда уходит трафик» — по маршрутам.
 *
 * Часть от целого «на глаз»: вопрос, ради которого на него смотрят, — идёт ли
 * заметная доля мимо туннеля, — решается одним взглядом, а точные числа стоят
 * в легенде рядом. Числа в кольце не пишем: подписи на долях меньше десятой
 * части всё равно не помещаются.
 *
