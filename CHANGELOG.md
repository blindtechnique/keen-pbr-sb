...
- **Карточка транспорта собрана заново.** Выключатель переехал в правый верхний угол, перезапуск — влево вниз, запуск и остановка из подвала убраны совсем: их делает выключатель. Три строки — интерфейс, сервер, соединение — теперь всегда одни и те же и в одном порядке, иначе соседние карточки не встают вровень; всё необязательное ушло в строку значков, где отсутствие ничего не двигает.
