...
- **Карточка транспорта собрана заново.** Действия расставлены по углам: задержка, перезапуск и выключатель — в правом верхнем, карандаш и корзина — в правом нижнем, иконками без подписей. Подписи ничего не объясняли, а забирали по две строки высоты на каждой карточке. Запуск и остановка из подвала убраны совсем: их делает выключатель. Три строки — интерфейс, сервер, соединение — теперь всегда одни и те же и в одном порядке, иначе соседние карточки не встают вровень; всё необязательное ушло в строку значков, где отсутствие ничего не двигает. Флаг страны остался один — рядом с протоколом; у строки сервера он повторял то же самое. Вид транспорта переехал в строку значков, рядом с DNS-туннелем: из подзаголовка его вытеснил протокол, но знать, кто держит туннель, всё же полезно.
