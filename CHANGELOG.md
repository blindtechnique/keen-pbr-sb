...
- В настройках обновления Alpha подготовлен постоянный выбор Stable/Alpha: сохранение канала не устанавливает пакет и не меняет VPN/DNS. Показаны выбранный и установленный каналы, полные версии и источник. Установка привязана к подтверждённым тегу и версии подписанного выпуска; изменение канала или выпуска требует новой проверки, понижение версии из панели запрещено. Обновление и пакетный откат не сбрасывают выбранный канал.
- Для Alpha подготовлена полная матрица `aarch64-3.10`, `mips-3.4`, `mipsel-3.4`: перед подписью проверяются комплектность, общая версия, исходный коммит и канал каждого пакета. Новая публикация через устаревший `next` удалена; проверка исторических подписей сохранена. Наличие настройки сборки не заменяет сборку и аппаратную приёмку конкретного выпуска.
