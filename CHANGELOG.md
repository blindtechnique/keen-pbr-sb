...
- Исправлены мобильная компоновка строк, кнопки обновлений и проверки, сообщения уведомлений и привязка результата проверки транспорта к точному интерфейсу.
