...
// package metadata, maintainer-script effects and paths introduced by a newer
// package require a pinned old IPK and a separate recovery transaction.
//
...
struct ComponentRestoreResult {
    ...
    // but opkg's database, the old IPK, maintainer-script side effects and
    // paths introduced only by a newer package are outside this snapshot.
