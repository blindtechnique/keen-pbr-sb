...
- **Failover через URLTest** — несколько выходов объединяются в резервируемую группу.
...
- **Соединения** — активные TCP/UDP-сессии, состояния, адреса, порты, маршрут, имя устройства Keenetic, фильтры и история до двух часов.
...
flowchart LR
    ...
    PBR -- "обычный трафик" --> DIRECT["Direct / провайдер"]
